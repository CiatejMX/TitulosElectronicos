     ...
     Vue.component( 'entidadfederativa', {
        template: `
            <main class="main">
            <!-- Breadcrumb -->
            <ol class="breadcrumb">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="row of array">
                                    ...
                                    <td>row.identidadfederativa</td>
                                    <td>row.c_nom_ent</td>
                                    <td>row.c_entidad_abr</td>
        ...
        `,
          ...
          methods : {
              listaEntidadfederativa(){
                axios.get('/ef/listar').then(function (response) {
                   Console.log(reponse);
                    this.array = response;
