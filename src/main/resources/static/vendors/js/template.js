...
$(document).ready(function($){
  ...
  $('a[href="#"][data-top!=true]').click(function(e){
    ...
    $("#Busca_Titulo").autocomplete({

				source : function(request, response) {
					$.ajax({
						url : "/titulo/buscanombre/" + request.term,
						dataType : "json",
						...
						success : function(data) {
							response($.map(data, function(item) {
								return {
									value : item.idtitulo,
									label : item.nombre +" "+ item.primerapellido +" "+ item.segundoapellido,
				...
				select : function(event, ui) {
					//$("#buscar_producto").val(ui.item.label);
                                        var idhistoricoenvio = $('input[name="idhistoricoenvio"]').val();
					//alert("selectccionado titulo" + ui.item.value +" historico "+ idhistoricoenvio);
                                        
                                        $.ajax({
						url : "/titulo/historicoenvio/guardaritem" ,
						dataType : "json",
                                                type:"GET",
						data : {
							idhistoricoenvio : idhistoricoenvio,
                                                        idtitulo: ui.item.value,
						},
						success : function(data) {
							location.reload();
						},
