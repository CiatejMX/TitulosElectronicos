...
CREATE TABLE `invoice_lines` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKm2jo8loc0ps5q6qtlx4nx6o3e` (`product_id`),
  KEY `FKsgudq2lwpa9wc92a23nggah1w` (`invoice_id`),
  CONSTRAINT `FKm2jo8loc0ps5q6qtlx4nx6o3e` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  CONSTRAINT `FKsgudq2lwpa9wc92a23nggah1w` FOREIGN KEY (`invoice_id`) REFERENCES `invoices` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-04-28 10:18:36
